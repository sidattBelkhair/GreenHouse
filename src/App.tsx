      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex space-x-8">
            <button 
              onClick={() => setCurrentScreen('farmer-info')}
            ...
            <button 
              onClick={() => setCurrentScreen('consumer-info')}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4">
            ...
            <button 
              onClick={() => {
                setCurrentScreen('consumer-info');
                setMobileMenuOpen(false);
              }}
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-10 mb-8">
              ...
              <div className="text-center">
                <button 
                  onClick={() => setCurrentScreen('farmer-packs')}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="border-4 border-green-500 rounded-2xl p-8 relative bg-gradient-to-br from-green-50 to-green-100">
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="text-3xl font-bold text-green-600 mb-4">30,000 MRO</div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-700">Commission de 10% seulement</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
              ...
              <div className="border-2 border-blue-300 rounded-2xl p-8 bg-gradient-to-br from-blue-50 to-blue-100">
                <div className="text-center mb-6">
                  ...
                  <div className="text-3xl font-bold text-blue-600 mb-4">10,000 MRO</div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div className="bg-green-50 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700">✅ GreenHouse applique une commission de 10% sur chaque vente</p>
              ...
              <form className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                      <option>Pack Premium - 30,000 MRO</option>
                      <option>Pack Starter - 10,000 MRO</option>
                    </select>
                  </div>
                </div>
                ...
                <button 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    setCurrentScreen('farmer-confirmation');
                  }}
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <form className="space-y-6">
                ...
                <button 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    setCurrentScreen('consumer-confirmation');
                  }}
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center">
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-3xl shadow-2xl p-12 text-center">
            ...
            <button 
              onClick={() => setCurrentScreen('home')}
              className="bg-green-600 text-white py-3 px-8 rounded-xl font-bold hover:bg-green-700 transition-colors"
            >
              Retour à l'accueil
            </button>
          </div>
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-2xl font-bold text-green-600">8,500 MRO</span>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-2xl font-bold text-green-600">6,000 MRO</span>
                    <button className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
                      Commander
                    </button>
                  </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-2xl font-bold text-green-600">35,000 MRO</span>
                    <button className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
                      Commander
                    </button>
                  </div>
